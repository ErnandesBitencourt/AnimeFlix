    ...
    return(
        ...
        <ContextoNovoVideo.Provider value={{
          ...
          <ContextoNovaCategoria.Provider value={{
            id:formCtg.id, name:formCtg.name, descricao:formCtg.descricao, codigo:formCtg.cotigo ,buttonNovaCategoria:buttonNovaCategoria, onChangeCtg:onChangeCtg, cleanCtg:cleanCtg, novaCtg:novaCtg,buttonDeleteCategoria:buttonDeleteCategoria, buttonEdita:buttonEdita,editCategoria:editCategoria , buttonSalvarEdicao:buttonSalvarEdicao
            }}>   
              <BrowserRouter>
                <Routes>
